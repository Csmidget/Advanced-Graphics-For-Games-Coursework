...
namespace Prefabs {
	Track<Camera>* BuildCameraTrack(Camera* cam)
	{
		...
		track->AddWaypoint(Vector3(-50.88f, 20.7f, 57.38f), Vector3(-27.19f, -43.4f, 0.0f), 11.0f);
		track->AddWaypoint(Vector3(-50.19f, 20.7f, -63.07f), Vector3(-21.35f, -135.1f, 0.0f), 11.0f);
	...
	Track<SceneNode>* BuildCompoundPatrol(SceneNode* target) {
		...
		track->AddWaypoint(Vector3(-2.0f, -15.4f,-10.0f), Vector3(0.0f, 0.0f, 0.0f));
		track->AddWaypoint(Vector3(-2.0f, -15.4f, 10.0f), Vector3(0.0f, 0.0f, 0.0f), 3.3f);
		track->AddWaypoint(Vector3(-2.0f, -15.4f, 10.0f), Vector3(0.0f, 90.0f, 0.0f));
		track->AddWaypoint(Vector3(18.0f, -15.4f, 10.0f), Vector3(0.0f, 90.0f, 0.0f), 3.3f);
		track->AddWaypoint(Vector3(18.0f, -15.4f, 10.0f), Vector3(0.0f, 180.0f, 0.0f));
		track->AddWaypoint(Vector3(18.0f, -15.4f,-10.0f), Vector3(0.0f, 180.0f, 0.0f), 3.3f);
		track->AddWaypoint(Vector3(18.0f, -15.4f,-10.0f), Vector3(0.0f, 270.0f, 0.0f));
		track->AddWaypoint(Vector3(-2.0f, -15.4f, -10.0f), Vector3(0.0f, 270.0f, 0.0f), 3.3f);
		track->AddWaypoint(Vector3(-2.0f, -15.4f, -10.0f), Vector3(0.0f, 360.0f, 0.0f));
		track->Start();
		return track;
	}
	...
	Track<SceneNode>* BuildBottomRightPatrol(SceneNode* target) {
		...
		track->AddWaypoint(Vector3(175.0f, -15.4f, 105.0f), Vector3(0.0f, 58.5f, 0.0f), 21.0f);
		track->AddWaypoint(Vector3(175.0f, -15.4f, 105.0f), Vector3(0.0f, 238.5f, 0.0f));
		track->AddWaypoint(Vector3(67.3f, -15.4f, 38.92f), Vector3(0.0f, 238.5f, 0.0f),21.0f);
		track->AddWaypoint(Vector3(67.3f, -15.4f, 38.92f), Vector3(0.0f, 58.5f, 0.0f));
		track->Start();
		return track;
	}
	Track<SceneNode>* BuildTopRightPatrol(SceneNode* target) {
		...
		track->AddWaypoint(Vector3(148.4f, -15.4f, -187.3f), Vector3(0.0f, 149.1f, 0.0f), 23.0f);
		track->AddWaypoint(Vector3(148.4f, -15.4f, -187.3f), Vector3(0.0f, -30.9f, 0.0f));
		track->AddWaypoint(Vector3(68.34f, -15.4f, -61.13f), Vector3(0.0f, -30.9f, 0.0f), 23.0f);
		track->AddWaypoint(Vector3(68.34f, -15.4f, -61.13f), Vector3(0.0f, 149.1f, 0.0f));
		track->Start();
		return track;
	}
	Track<SceneNode>* BuildLeftPatrol(SceneNode* target) {
		...
		track->AddWaypoint(Vector3(-178.1f, -15.4f, 3.518f), Vector3(0.0f, -90.0f, 0.0f), 19.0f);
		track->AddWaypoint(Vector3(-178.1f, -15.4f, 3.518f), Vector3(0.0f,  90.0f, 0.0f));
		track->AddWaypoint(Vector3(-62.03f, -15.4f, 3.223f), Vector3(0.0f,  90.0f, 0.0f), 19.0f);
		track->AddWaypoint(Vector3(-62.03f, -15.4f, 3.223f), Vector3(0.0f, -90.0f, 0.0f));
		track->Start();
		return track;
	}
